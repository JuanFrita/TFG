...
def main(imagenes="assets\\images", anotaciones="assets\\annotations", split_ratio=0.7):   
    ...
    netP2p = P2Pnet()
    destinoP2P = f"assets\\estructuraP2P{fecha_hora_actual.strftime('%Y-%m-%d_%H-%M-%S')}"
    ...
    destinoBayesian =  f"assets\\estructuraBayesian{fecha_hora_actual.strftime('%Y-%m-%d_%H-%M-%S')}"
